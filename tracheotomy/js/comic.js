...
/*
why did i write this in such a stupid way the first time lmao, just call the gotopage 
...
document.querySelector(".nextpage").addEventListener("click", pageButton)
document.querySelector(".prevpage").addEventListener("click", pageButton)